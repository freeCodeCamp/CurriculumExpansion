...
// Inside the body of the `if` statement, send back a response saying `Error: the ticker you entered is invalid.`  This is similar to how to previously sent responses with `res.send()`.  Also be sure to use template literals in your response message.
