...
Promise.all([getJSONData, getCSVData]).then(function(values) {
  ...
  /*
  Now that you have an anchor element in the HTML in place, you'll want to create
  a selection of it to use in the script. Using the `const` keyword, declare a
  variable named `tooltip`, and set it to a `d3` selection of the element with
  the ID of `tooltip`.
  */
