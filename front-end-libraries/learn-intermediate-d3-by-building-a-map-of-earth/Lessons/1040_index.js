...
the SVG width. This variable will be the `x` position of where the legend starts
on the SVG. By positioning the legend in the middle of the SVG and having a total
width of half the SVG less `4` pixels, you're giving the legend a `4` pixel margin
on the right so it's not directly up against the side of the viewing area.
*/
