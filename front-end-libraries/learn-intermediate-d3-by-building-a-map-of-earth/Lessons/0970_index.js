...
chain the `.call()` method and pass it the `d3.zoom()` function. `.call()` applies
the `d3.zoom()` function to the SVG, which binds a number of event listeners that
relate to panning and zooming. It will handle wheel spins of a mouse or pinching
to zoom, as well as click and drag or touch and drag to pan to name a few.
*/
