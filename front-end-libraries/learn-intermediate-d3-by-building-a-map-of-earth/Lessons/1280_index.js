...
/*
The `.ticks()` method tells D3 how to generate and format the ticks, but here
you'll use it as a convenience to set the number of ticks. You only want the tick
marks between the color blocks, so you only need 7. Pass the method a calculation
for this value.

An alternative to specify the number of ticks is to use `.tickArguments([n])`.
*/
