...
does change dynamically, as each rectangle is a different population threshold
color. Since the bound data is the actual set of the eight colors from the `color`
scale, your callback function should just return the data parameter (by convention,
this is typically represented as `d`).
*/
