...
outlines, you're going to create one to hold all the legend-related elements.

Using the `const` keyword, declare a variable named `legend`, then set it to a
group element you append to the SVG.
*/
