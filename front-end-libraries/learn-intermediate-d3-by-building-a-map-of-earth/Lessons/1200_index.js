...
and `y_0` as the starting point for any positioning code. You want the title to
be positioned above the color blocks, so chain an attribute method for the `"y"`
position, and pass it a value of `-10`.
*/
