...
another `.on()` method, this one for the `"mousemove"` event, and set up an empty
callback function with a parameter named `d`. The callback function will create
the actual box with the tooltip's information in it and position it on the page.
*/
