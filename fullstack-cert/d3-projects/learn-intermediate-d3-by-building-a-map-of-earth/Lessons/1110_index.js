...
divided by the number of colors. Essentially this is the width of each rectangle,
which corresponds to the `x` position of the second one. Recall that the scale
will automatically output a `0` position for the first rectangle to position it
at the legend's origin.
...
index value of a rectangle. It returns evenly-spaced values (based on the width
`w` you set for the legend) that you'll use as the x coordinate for each colored
rectangle.
*/
