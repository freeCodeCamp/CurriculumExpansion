...
tooltip by 32 pixels more than where the mouse is (this will push the tooltip 32
pixels lower than the mouse) and make sure to concatenate `"px"` to this value
as well.
*/
