...
The for...in statement iterates over the properties of an object keyed by strings.

For Example: 

const objExample = {animals: [{cats: 3}, {dogs: 4}, {birds: 7}]}

let newObjExample = []
  for(props in objExample) {
  newobjExample = objExample[props]


Convert our object newsFeed into an array by iterating over it with the for...in statement
and returning the result of each iteration into our newsFeedArray array. 
*/
