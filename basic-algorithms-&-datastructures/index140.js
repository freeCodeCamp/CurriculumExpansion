...
/*
The Object.keys() method returns an array of the property names of the object in the same order as a normal loop
and has considerable more browser support than Object.values().

Convert the newsFeed object property names into an array with Object.keys.

Example: 
const objectToDoList = {'make the bed': true, 'learn Javascript': true, 'walk the dog': false }
Object.keys(objectToDoList)

// returns  (3) ["make the bed", "learn Javascript", "walk the dog"]
*/
