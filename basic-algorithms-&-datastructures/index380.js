...
// Search Filter for the author's name: Steve Ramsey in NewsFeedArray
newsFeedArray.filter(filterName => filterName.author.name === 'Steve Ramsey')
// returns: 0: {headline: "The Next Big Thing in Algorithms", id: "e9jbk9", image: Array(0), date_published: "2019-12-10T16:47:29.000Z", date_modified: "", …} 1: {headline: "Data Structures and Algorithms Cheat Sheet for New Developers", id: "e9jbdf", image: Array(0), date_published: "2019-11-30T09:52:22.000Z", date_modified: "", …}  2: {headline: "The Next Big Thing in Algorithms", image: Array(0), date_published: "2018-12-30T11:58:00+11:00", date_modified: "", author: {…}, …}


/*
With our new search alogirthm, let's create an advanced dynmaic search prompt where our user's can input an author's name and recieve the article results according to that name from the database. 

The window prompt() method makes a display box from the browser which requests a user input.

Above our Search Filter set to the string of 'Steve Ramsey', Create a prompt with a string value of: 'Search Articles By Authors'

For Example: prompt('Testing, 1 2 3!')
*/