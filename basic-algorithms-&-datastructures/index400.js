...
/*
When we refresh our index.html page, we are now prompted and the user input results is stored to author.

To make our Search Filter dynamically listen to the user input prompt, we can now set it to our author variable. 

Change the Search Filter value of 'Steve Ramsey' to the let variable of author.
*/