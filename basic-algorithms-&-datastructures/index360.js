...
colorsArray.filter(color => color === 'green') // return ["green"]

/*
Now that we've reviewed the JavaScript filter() method initial basics, remove the colorsArray and colorsArray filter code.

Let's apply our new knowledge back to our newsfeed database. Filter all the articles objects with the author name of 'Julie Holmes'. 

Hints: The filter() method filters through an array and not an object. We can use dot notation to select authors.  
