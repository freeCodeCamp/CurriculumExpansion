...
/*
Let's write a search algorithm to return only the articles of an author's given name.

We can use the filter() method to create a new array that returns only the elements which pass as true
depending on the provided function condition.

An example that creates an animalsArray which takes four different animal names as strings:
animalsArray = ['cat','dog','bird','elephant'].

Write a new array colorsArray and add strings of the colors: green, yellow, blue, and orange. 
