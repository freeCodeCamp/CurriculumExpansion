...
if(searchFormula.length > 0) {
  ...
  console.log('Search Results By Author: ', 'Sorry, but the author name you requested does not match any results.')
}

/*
Let's refactor our duplicate code and complete the dynamic search algorithm. 

Above our let author declaration, create a new const searchString and set it to the string value of: 'Search Results By Author: '
*/