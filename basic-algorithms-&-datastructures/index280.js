...
/*
Since both arguments a and b are not defined, the compareSections function has nothing specifically assigned to compare its logic. 

Assign a and b to the value of the name property belonging to section of the array newsFeedArray and modify the compareSections function accordingly.

Example:
To assign a and b to the headline's property value we would do the following:
a.newsFeedArray.headline
b.newsFeedArray.headline
*/
