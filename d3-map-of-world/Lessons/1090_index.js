...
the rectangles to the map. It will take an index representing each of the eight
colors that need a rectangle (numbered 0-7), then output the `x` position. By
using a linear scale on consecutive integers, you make sure the rectangles are
positioned at equal intervals within the space you set with your `w` constant.

Using the `const` keyword, declare a variable named `x` and set it to a D3
