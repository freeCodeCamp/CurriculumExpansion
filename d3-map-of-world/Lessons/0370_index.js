...
/*
Next, create the request for the CSV population data.

Using the `const` keyword, declare a variable named `getCSVData` that is set to
D3's `.csv()` method, and pass the method your `popPath` variable.
*/
