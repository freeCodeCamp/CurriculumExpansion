...
attribute is the same for all rectangles, so you won't need a dynamic callback
function for the value. Set it so each rectangle is the width of the legend
