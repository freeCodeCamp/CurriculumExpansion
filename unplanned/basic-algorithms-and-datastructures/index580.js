...
// return {Algorithms: Array(3), Artificial Intelligence: Array(3), JavaScript: Array(2), Linux: Array(1), Programming: Array(4), …}

/*
Let's write a final algorithm feature for our newsFeed which stars to our users popular articles. 

The for...of statement, similar to for...in, create a loop that iterates over data, however the for...of statement iterates over data strings and arrays as opposed to objects.
