...
/*
Now that our compareSections function is complete, log the sort() method applied to the newsFeedArray array with the compareSections function as its input. 

Ex:
console.log(array.sort(compareFunction))

Bonus: 
Create another compare function to compare and return the newsFeedArray data alphabetically
by the author's username. Log the results.  
*/
