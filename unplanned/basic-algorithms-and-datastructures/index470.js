...
if(searchFormula.length > 0) {
  ...
  console.log('Sorry, but the author name you requested does not match any results.')
}

/*
Now let's identify our console error message if the searchFormula returns no results. 

Copy the string value 'Search Results By Author: ' in our if console.log and concatenate it to our else console.log 'Search Results By Author: ' 
*/