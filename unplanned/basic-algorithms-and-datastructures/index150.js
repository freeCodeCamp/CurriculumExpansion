...
Another method for arrays is map() which return a new array with a provided call back function.

var mapExample = {colors: ['red', 'blue', 'green', 'yellow']}
mapExample.colors.map(color => color) // returns (4) ["red", "blue", "green", "yellow"]

Map through the articles property array in the newsFeed section to  return each element in the object into the new array. 

Remember to select the article properties which is an array with dot notation: newsFeed.articles.
*/