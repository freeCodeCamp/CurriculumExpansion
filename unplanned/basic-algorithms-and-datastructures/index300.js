...
/*
Although our sorting sections algorithm is now working, it can benefit additionally from some
refactoring.  Refactoring is a computer coding method which improves the internal structure of the code without
effecting the external behaviour.

In the compareSections function, create two new const variables called sectionA and sectionB.
*/
