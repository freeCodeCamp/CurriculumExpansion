...
/*
Let's create an alogrithm to sort our newsfeed sections alphabetically and continue expanding upon our
knowledge of the sort() method. 

We can create a compare function which passes a logical argument to sort().

To complete the compareSections function above, first, declare a let block scope called result to the numerical value of 0.
