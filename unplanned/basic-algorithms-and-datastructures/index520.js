...
/*
Beneath our groupBySections function, call the function in a console log which also passes the string 'Group Newsfeed by sections:' Leave the call argument empty for now. 

*To call a function we execute the inner script of the function by implementing brackets.  For Example: 

function callFunction() {
  console.log('this function has been called.')
}
callFunction() // returns this function has been called.
*/