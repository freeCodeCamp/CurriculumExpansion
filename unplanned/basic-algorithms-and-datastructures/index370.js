...
/*
As more people write new articles in our newsFeed, so does our database grow. We have added additional article objects into our original newsFeed Object to reflect this.

If we console the same search filter algorithm again, we will now see our results updated from 2 objects to 6 objects.

Create a new filter author name search of all the articles objects, but this time find the author with the name 'Steve Ramsey'. 
*/