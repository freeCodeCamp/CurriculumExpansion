...
/*
Now that we have successfully created an algorithm to return the newsfeed data by the most recent date published,
 add comments to shortly explain the newly completed algorithm.
*/
