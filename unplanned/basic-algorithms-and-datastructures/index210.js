...
/*
The sort() method orders the items in an array either alphabetically or numerically (ascending or descending). To sort an array of numbers or letters in an ascending order we can simply 
apply the sort() method to the array.

For example:
var randomNumbers = [4,5,2,8,0] 
randomNumbers.sort() // returns [0, 2, 4, 5, 8]

Sort the following array in an ascending order: var randomLetters = ['t','q','a','c','b']
