...
/*
Now let's rewrite the compareSectionsfunction from a regular function to an ES6 arrow function.

Arrow functions, (or lambda functions) are concisely written functions by returning values implicitly in one line; single return functions.
They can be declared with const or let in ES6 and use a fat arrow =>. 
For Example: function regularFunction() {} VS. const arrowFunction = () => {}

Refactor the compareSections regular function declaration into a const declared ES6 arrow function.
