...
/*
Similar to the let statement, const are block-scoped variables. However, the value of a const assigned variable 
cannot be changed.

Declare a new const variable entitled newsFeedObjValues without setting it to any value.
