...
In the reduce() method's reducer function's parameters, the accumulator argument accumulates the return values of each element execution from the callback on the array. The currentValue argument is the current element being executed by the callback. 
In addition to numerical values, the initialValue option may also be set to an object or array.

Add the reducer function to the reduce() method with the arguments of an accummulator and a currentValue. 
Set an initialValue option to an empty object.
*/