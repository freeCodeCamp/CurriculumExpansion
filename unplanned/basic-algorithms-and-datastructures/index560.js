...
['red','red','blue','green','yellow','green'].reduce((accumulator, currentValue) => {(accumulator[currentValue] = accumulator[currentValue] || [] ).push(currentValue)  
  return accumulator }, []) // returns [red: Array(2), blue: Array(1), green: Array(2), yellow: Array(1)]

/*
Back in the groupBySections function, apply the same logic in the reducer function to push new arrays of the currentValue whenever the accumulator of the currentValue is the same or create the next array.

Clean up the code and remove the colors array example.
*/