...
(accumulator[currentValue] = accumulator[currentValue] || []).push(currentValue)
return accumulator
}, {})
};
...
/*
Now that we are calling groupBySections with the input of newsFeedArray we are returning our object from the array.

However, since we are not specifiying the section names we are comparing all the values of currentValue to eachother.

To complete our logic in the reducer function, specify the currentValues to the section names using dot notation.
*/