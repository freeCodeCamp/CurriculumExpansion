...
/*
  Use the `style` function to set the `cursor` to `pointer`. This style added throughout the project will be for a little visual indicator on hover events you will add later.
*/
