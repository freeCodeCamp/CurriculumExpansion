...
/*
  The line graph is looking good. Next, you are going to add a `div` to put the pie graph and the legend in. Create a new `const` variable named `rightDashboard` and set equal to `d3.select('.dashboard')`.
*/
