...
/*
  Use the `domain` function on the scale and pass it the value `data[8].followers`. This will be the data from 2019 and will contain three items, one for each platform.
*/
