...
/*
  Use the `domain` function on the scale and pass it the value `data[8].followers`. This will be an array of the data from 2019 that contains three items, one for each platform.
*/
