...
/*
  Where you appended the `path` for the chart, set the `fill` attribute to the function `d => pieColors(d.data.key)`. This will send the key (platform) of each data point to the `pieColors` function and return the range value that key is mapped to.
*/
