...
/*
  On a new line, add another `selectAll` function to you `lineGraph` variable and pass it the string: `instagram-circles`. These will be circles for the instagram line.
*/
