...
/*
  Using the `style` function again, set the `background-color` to the function `d => pieColors(d.key)`. This will pass the `key` to `pieColor` and return the color. So the `twitter` key will return `twitterColor`.
*/
