...
/*
  Since the domain has three items, the range also needs to have three items. If it has less, the values will just repeat, putting the same color on the pie chart multiple times. Add the `range` function to the scale and pass it this array: `['#00fff6', '#f6dd71', '#fd9b98']`.
*/
