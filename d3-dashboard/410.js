...
/*
  Chain a `value` function to `pie` and pass it the value `d => d.value`. Each piece of data passed to `pie` will have a `key` (platform) and a `value` (number of followers), you want to return the value.
*/
