...
/*
  ...
  Basically, your graph will have a margin around it for things like axes and labels. So the actual line data will display on the inside of this margin area, which is why the bottom the of the graph is the `svgHeight` minus the `svgMargin`. It might sound confusing right now, but it will become more clear as you progress through this project.
*/
