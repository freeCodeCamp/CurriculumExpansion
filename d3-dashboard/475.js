...
/*
  Chain a `text` function to set the text of each pie slice to a percentage. Set the value to an arrow function with `d` as the parameter and leave the function empty. It should look like this:
