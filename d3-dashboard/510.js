...
/*
  `append` a `tr` element to the selection and then append a `th` element after it. `tr` is for defining a row of the table, and `th` is for defining the header cells of the table.
*/
